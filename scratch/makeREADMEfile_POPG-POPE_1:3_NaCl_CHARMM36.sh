...
molecule2=POPE
molecule3=150mNaCl
fractionOFmolecule=66
lipid=500lipids
temperature=T310K
model=MODEL_CHARMM36
dataDOI=https://zenodo.org/record/2579108#.XKyz3kN7mHl
trajectoryLINK=https://zenodo.org/record/2579108/files/m_400_500_PG_PE_1_3_charmm.xtc
topolLINK=https://zenodo.org/record/2579108/files/md_04.tpr
confLINK=
