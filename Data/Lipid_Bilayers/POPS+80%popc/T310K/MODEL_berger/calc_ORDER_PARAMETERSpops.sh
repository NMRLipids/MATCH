#!/bin/bash
mappingFILE=mappingFILEpops.txt
groOPpath=gro_OP.awk

HGGLYoutname=Headgroup_Glycerol_Order_Parameters_SimulationPOPS.dat
sn1outname=sn-1_Order_Parameters_SimulationPOPS.dat
sn2outname=sn-2_Order_Parameters_SimulationPOPS.dat
...
! [ -s runPROT.gro ] && echo POPS | /home/samuli/Gromacs/gromacs402/bin/protonate -f trajINBOX.xtc -s topol402.tpr -o runPROT.gro
