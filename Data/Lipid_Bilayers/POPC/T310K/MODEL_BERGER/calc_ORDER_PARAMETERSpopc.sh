...
##  ! [ -s trajINBOX.xtc ] && echo System | /home/samuli/gromacs/gromacs407/bin/trjconv -f run.trr -s topol.tpr -o trajINBOX.xtc -pbc res 
##  echo POPC | /home/samuli/gromacs/gromacs407/bin/protonate -f trajINBOX.xtc -s topol407.tpr -o runPROT.gro
