...
scriptdir='/Users/osollila/NMRlipids/MATCH/scratch/scriptsBYmelcr'
...
#    if [ -s run.cpt ]
#    then
        echo $lipid | gmx trjconv -f trajectory.xtc -s $tpr_file_name -o $top_file_name -pbc mol -dump 50000 #-n index.ndx
#    else
